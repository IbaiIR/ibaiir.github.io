...
<section>
 ...
 <!-- Left Column / Headphones Image -->
                <div class="left-column">
                  <img class= "team-membi" src="<?= base_url("assets/img/esk$esk->zk.png")?>">
                </div>
...
<div class="responsive-container-block1 outer-container1">
  <div class="responsive-container-block1 inner-container1">
    ...
    <?php if ($eskat == []): ?>
      ...
      Eskuizkribu hau ez dago atalkaturik
    </p>
      <?php else: ?>
    
        <p class="text-blk section-head-text">
      Eskuizkribuaren atalak
    </p>
      <div>
    <button type="button" class="collapsible">ikusi</button>
      <div class="content">
            ...
            <tr>
                ...
                <th>Eskuizkribuko orrialdeak</th>
                <th>Hizkuntza nagusia</th>
                <th>Gaia</th>
                <th>Oharrak</th>
                <th>Editatua</th>
            </tr>
        ...
        <?php foreach ($eskat as $eat): ?>
            <tr>
                <td><?= $eat->atal_zenbakia;?></td>
                <td><?= $eat->atal_izenburua;?></td>
                <td><?= $eat->eskuizkribuko_or;?></td>
                <td><?= $eat->hizkuntza_nagusia;?></td>
                <td><?= $eat->gaia;?></td>
                <td><?= $eat->oharrak;?></td>
                <?php if ($eat->editatua == "Editatua"): ?>
                <td><form method="GET" action="/eskuatal"><input type= "hidden" name="zka" value="<?= $eat->zenbaki_globala;?>"><button class="button" type="submit">Edizioak</button></form></td>
                <?php endif ?>
            </tr>
        <?php endforeach ?>
        </table>
...
<?php endif ?>
  ...
  <div class="responsive-container-block inner-container">
    ...
    <?php foreach ($edizio as $edi): ?>
      <?php if (!in_array($edi->Zenbakia, $Zk)):?>
        <swiper-slide>
            <div class="card">
