...
<section>
    ...
    <?php if ($eskat == []): ?>
     ...
     <p><b>Atalaren zenbakia: </b> <?= $eat->atal_zenbakia;?></p>
                    <p><b>Atalaren izenburua:</b> <?= $eat->atal_izenburua;?></p>
                    <p><b>Eskuizkribuko orrialdeak:</b> <?= $eat->eskuizkribuko_or;?></p>
                    <p><b>Hizkuntza nagusia:</b> <?= $eat->hizkuntza_nagusia;?></p>
                    <p><b>Gaia:</b> <?= $eat->gaia;?></p> 
...
<?php endif ?>
  ...
  <div class="responsive-container-block inner-container">
    ...
    <p class="section-subhead-text" text-align="center">
      Atal hau honako lanetan aurki daiteke:
    </p>
